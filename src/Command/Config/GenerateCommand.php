...
class GenerateCommand extends GeneratorCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('build-makefile', null, InputOption::VALUE_OPTIONAL, 'Whether to install from a Drush Make file')
            ->addOption('install-site', null, InputOption::VALUE_OPTIONAL, 'Install the site when the VM is provisioned')
